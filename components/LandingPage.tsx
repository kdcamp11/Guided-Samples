...
import { ArrowRight, Sparkles, Layers, Eye, FileText, Send, CheckCircle2 } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 overflow-y-auto">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 leading-tight mb-5">
          From concept to<br/>
          <span className="text-brand-green">production-ready</span> in 6 phases
        </h1>
        <p className="text-gray-500 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
          Generate garments and logos, apply your design, preview it on a model, build a full tech pack, and send it straight to your supplier.
        </p>
        <div className="flex items-center justify-center gap-4">
          <button onClick={onEnter} className="btn-primary flex items-center gap-2 px-6 py-3 text-sm">
            <Sparkles size={15}/> Start Designing
          </button>
          <a href="#workflow" className="btn-secondary flex items-center gap-2 px-5 py-3 text-sm">
            See the Workflow
          </a>
        </div>
      </section>
